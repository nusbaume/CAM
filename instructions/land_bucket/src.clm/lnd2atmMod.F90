...
contains
  ...
  subroutine lnd2atm(bounds, &
    ...
    !RPF - adding 'no lake' version of qflx_evap_tot
    call p2g(bounds, &
         water_inst%waterfluxbulk_inst%qflx_evap_tot2_patch (bounds%begp:bounds%endp), &
         water_inst%waterlnd2atmbulk_inst%qflx_evap_tot2_grc     (bounds%begg:bounds%endg), &
         p2c_scale_type='unity', c2l_scale_type= 'urbanf', l2g_scale_type='unity')

    !RPF - try adding constituent fluxes here. (Not sure this is correct!)
    !Soil evap
    call p2g(bounds, &
         water_inst%waterfluxbulk_inst%qflx_evap_soi_patch (bounds%begp:bounds%endp), &
         water_inst%waterlnd2atmbulk_inst%qflx_evap_soi_grc     (bounds%begg:bounds%endg), &
         p2c_scale_type='unity', c2l_scale_type= 'urbanf', l2g_scale_type='unity')

    !transpiration
    call p2g(bounds, &
         water_inst%waterfluxbulk_inst%qflx_tran_veg_patch (bounds%begp:bounds%endp), &
         water_inst%waterlnd2atmbulk_inst%qflx_tran_veg_grc     (bounds%begg:bounds%endg), &
         p2c_scale_type='unity', c2l_scale_type= 'urbanf', l2g_scale_type='unity')

    !interception
    call p2g(bounds, &
         water_inst%waterfluxbulk_inst%qflx_evap_can_patch (bounds%begp:bounds%endp), &
         water_inst%waterlnd2atmbulk_inst%qflx_evap_can_grc     (bounds%begg:bounds%endg), &
         p2c_scale_type='unity', c2l_scale_type= 'urbanf', l2g_scale_type='unity')
...
!RPF - pass roughness length
    call p2g(bounds, &
         frictionvel_inst%z0m_patch (bounds%begp:bounds%endp), &
