module clm_cpl_indices
  ...
  integer, public ::index_l2x_Sl_z0m          ! RPF - roughness length 
  ...
  integer, public ::index_l2x_Fall_evpnl      ! evaporation     water flux
  !RPF-add constituent fluxes! NOTE: CLM5 seems to have a different qflx structure!
  integer, public ::index_l2x_Fall_trans      ! transpiration   water flux
  integer, public ::index_l2x_Fall_sevap      ! soil(+lake) evp water flux
  integer, public ::index_l2x_Fall_inter      ! interception    water flux
  integer, public ::index_l2x_Fall_levap      ! land evap flux
  !/RPF
...
contains
  ...
  subroutine clm_cpl_indices_set( )
    ...
    index_l2x_Sl_z0m        = mct_avect_indexra(l2x,'Sl_z0m') ! pass roughness length - RPF
    ...
    index_l2x_Fall_evpnl    = mct_avect_indexra(l2x,'Fall_evpnl')
    !RPF-add evap constituent fluxes over land
    index_l2x_Fall_trans    = mct_avect_indexra(l2x,'Fall_trans')
    index_l2x_Fall_sevap    = mct_avect_indexra(l2x,'Fall_sevap')
    index_l2x_Fall_inter    = mct_avect_indexra(l2x,'Fall_inter')
    index_l2x_Fall_levap    = mct_avect_indexra(l2x,'Fall_levap')
    !/RPF
