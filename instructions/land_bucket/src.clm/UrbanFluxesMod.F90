...
contains
  ...
  subroutine UrbanFluxes (bounds, num_nourbanl, filter_nourbanl,                        &
    ...
    associate(                                                                & 
         ...
         !RPF - qflx_evap_tot2 version w/o lake fluxes
         qflx_evap_tot2      =>   waterfluxbulk_inst%qflx_evap_tot2_patch       , & ! Output: [real(r8) (:)   ]  qflx_evap_soi + qflx_evap_can + qflx_tran_veg     
