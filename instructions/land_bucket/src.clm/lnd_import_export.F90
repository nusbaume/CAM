...
contains
  ...
  subroutine lnd_export( bounds, waterlnd2atmbulk_inst, lnd2atm_inst, lnd2glc_inst, l2x)
    ...
    do g = bounds%begg,bounds%endg
       ...
       l2x(index_l2x_Fall_evpnl,i)  = -waterlnd2atmbulk_inst%qflx_evap_tot2_grc(g) !RPF - evap2 w/out lake fluxes
       l2x(index_l2x_Fall_levap,i)  = -waterlnd2atmbulk_inst%qflx_evap_tot_grc(g)
       !RPF - add TEI constituent fluxes?
       l2x(index_l2x_Fall_trans,i)  = -waterlnd2atmbulk_inst%qflx_tran_veg_grc(g)
       l2x(index_l2x_Fall_sevap,i)  = -waterlnd2atmbulk_inst%qflx_evap_soi_grc(g)
       l2x(index_l2x_Fall_inter,i)  = -waterlnd2atmbulk_inst%qflx_evap_can_grc(g)
       !/RPF
       ...
       !if (index_l2x_Sl_z0m       /= 0 )  l2x(index_l2x_Sl_z0m,i)      =  lnd2atm_inst%z0m_grc(g) !RPF - pass roughness length
       l2x(index_l2x_Sl_z0m,i)      =  lnd2atm_inst%z0m_grc(g) !RPF - pass roughness length
