...
contains
  ...
  subroutine BareGroundFluxes(bounds, num_noexposedvegp, filter_noexposedvegp, &
    ...
    associate(                                                                       & 
         ...
         qflx_evap_tot2         => waterfluxbulk_inst%qflx_evap_tot2_patch          , & ! Output: [real(r8) (:)   ]  qflx_evap_soi + qflx_evap_can + qflx_tran_veg - lake_evap                        
      ...
      do f = 1, num_noexposedvegp
         ...
         qflx_evap_tot2(p) = qflx_evap_soi(p) ! RPF - populate qflx_evap_tot2 for qflx_tot - lake_evap
