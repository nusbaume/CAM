...
contains
  ...
  subroutine cam_cpl_indices_set( )
    ...
    index_a2x_Faxa_rainc_17O= mct_avect_indexra(a2x,'Faxa_rainc_17O', perrWith='quiet')
    index_a2x_Faxa_rainl_17O= mct_avect_indexra(a2x,'Faxa_rainl_17O', perrWith='quiet')
    index_a2x_Faxa_snowc_17O= mct_avect_indexra(a2x,'Faxa_snowc_17O', perrWith='quiet')
    index_a2x_Faxa_snowl_17O= mct_avect_indexra(a2x,'Faxa_snowl_17O', perrWith='quiet')
    index_a2x_Faxa_rainc_HTO= mct_avect_indexra(a2x,'Faxa_rainc_HTO', perrWith='quiet')
    index_a2x_Faxa_rainl_HTO= mct_avect_indexra(a2x,'Faxa_rainl_HTO', perrWith='quiet')
    index_a2x_Faxa_snowc_HTO= mct_avect_indexra(a2x,'Faxa_snowc_HTO', perrWith='quiet')
    index_a2x_Faxa_snowl_HTO= mct_avect_indexra(a2x,'Faxa_snowl_HTO', perrWith='quiet')
